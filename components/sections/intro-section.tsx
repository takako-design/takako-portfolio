...
const strengths = [
  {
    ...
    description:
      "まだ言葉になっていない想いや、大切にしたい価値観まで。対話を通して丁寧にくみ取り、その人らしさの核を見つけていきます。",
  },
  {
    number: "02",
    title: "魅力が伝わる、情報を整える。",
    description:
      "色、余白、写真、言葉、構成を丁寧に選びながら、伝えたい魅力が自然に届くよう、情報の見せ方とブランドの空気感を整えます。",
  },
  {
    number: "03",
    title: "行動につながる、導線を考える。",
    description:
      "ただ美しく見せるだけでなく、見る人が迷わず理解し、問い合わせ・予約・購入などの行動につながるよう、情報の優先順位や導線を整えます。",
  },
];

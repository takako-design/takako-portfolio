    ...
    <main className="min-h-screen bg-[#fbfaf6] text-[#17130f]">
      <section className="px-6 pb-20 pt-32 md:px-10 lg:px-16 lg:pb-28 lg:pt-40">
        <div className="mx-auto max-w-6xl">
          <p className="mb-6 text-[12px] font-light uppercase leading-relaxed tracking-[0.35em] text-[#b7aa9a]">
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              ...
              <p className="mt-8 max-w-xl text-sm font-light leading-[2.1] tracking-[0.06em] text-[#5f584f] md:text-base">
            ...
            <div className="space-y-1 border-l border-[#ded7ca] pl-6 text-[12px] font-light leading-[2.2] tracking-[0.07em] text-[#6d655b] md:text-[13px]">
              {caseMeta.map((item) => (
                <p key={item}>{item}</p>
              ))}
            </div>
      ...
      <section className="px-6 py-20 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.35fr_0.65fr]">
          <div>
            <p className="text-[12px] font-light uppercase leading-relaxed tracking-[0.35em] text-[#b7aa9a]">
              Overview
            </p>
          </div>

          <div className="space-y-8 text-sm font-light leading-[2.15] tracking-[0.06em] text-[#5f584f] md:text-base">
            <p>
              LUNÉA
      ...
      <section className="px-6 py-20 md:px-10 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <p className="mb-10 text-[12px] font-light uppercase leading-relaxed tracking-[0.35em] text-[#b7aa9a]">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {challengeItems.map((item) => (
              ...
              >
                ...
                <p className="text-sm font-light leading-[2.05] tracking-[0.06em] text-[#6d655b]">
                  {item.text}
                </p>
              </div>
            ))}
      ...
      <section className="px-6 py-20 md:px-10 lg:px-16">
        <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.35fr_0.65fr]">
          ...
          <div>
            ...
            <div className="mt-10 space-y-8 text-sm font-light leading-[2.15] tracking-[0.06em] text-[#5f584f] md:text-base">
              <p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {designPoints.map((item, index) => (
              ...
              >
                ...
                <h3 className="mb-4 text-[15px] font-light leading-[1.8] tracking-[0.08em] text-[#17130f] md:text-base">
                  {item.title}
                </h3>
                <p className="text-sm font-light leading-[2.05] tracking-[0.06em] text-[#6d655b]">
                  {item.text}
      ...
      <section className="px-6 pb-28 pt-20 md:px-10 lg:px-16 lg:pb-36">
        <div className="mx-auto flex max-w-6xl flex-col gap-7 border-t border-[#ded7ca] pt-10 md:flex-row md:items-center md:justify-between">
          <Link
            href="/"
            className="text-[12px] font-light uppercase tracking-[0.3em] text-[#6d655b] transition hover:text-[#17130f]"
          >
            Back to Top
          </Link>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex w-fit border border-[#6d655b] bg-white/35 px-7 py-3.5 text-[12px] font-light uppercase tracking-[0.25em] text-[#6d655b] transition hover:border-[#17130f] hover:bg-[#17130f] hover:text-white"
          >
            View Site
          </a>
        </div>

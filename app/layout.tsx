...
export const metadata: Metadata = {
  ...
  description: '介護・医療の現場を20年以上経験した、寄り添えるWebデザイナー。丁寧に寄り添い、心を動かすデザインを。Webサイト・LP・バナー制作承ります。',
  keywords: ['Webデザイン', 'Webデザイナー', 'ポートフォリオ', 'LP制作', 'バナー制作', '介護', '医療', 'ホームページ制作'],
  authors: [{ name: 'TAKAKO' }],
  creator: 'TAKAKO',
  robots: {
    index: true,
  ...
  openGraph: {
    ...
    description: '介護・医療の現場を20年以上経験した、寄り添えるWebデザイナー。丁寧に寄り添い、心を動かすデザインを。',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
